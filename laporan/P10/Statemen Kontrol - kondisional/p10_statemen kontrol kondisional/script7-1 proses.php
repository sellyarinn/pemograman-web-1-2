...
// bilangan ke-3. jika x > dari bil 3,maka x adalah max semua bilangan.jika tidal,maka bil 3 sbg max nya
...
echo "<p>Nilai maxsimum dari ".$bilangan1.", ".$bilangan2.", dan ".$bilangan3." adalah : ".$maxAkhir."</p>";

// cara ke - 2
// idenya adalah langsung membagikan masing masing bilangan dengan bilangan yang lain.
...
// cara ke - 3
// idenya hampir sama dengan cara ke - 1,tapi tidak dengan mencarimax sementara
